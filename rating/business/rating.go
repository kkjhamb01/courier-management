...
import (
	...
	delivery "github.com/kkjhamb01/courier-management/grpc/delivery/go"
	"github.com/kkjhamb01/courier-management/party/db"
	"github.com/kkjhamb01/courier-management/rating/domain"
...
func (s *Service) CreateCourierRating(ctx context.Context, in *pb.CreateCourierRatingRequest) (*pb.CreateCourierRatingResponse, error) {
	...
	return &pb.CreateCourierRatingResponse{}, nil
}
...
func (s *Service) CreateClientRating(ctx context.Context, in *pb.CreateClientRatingRequest) (*pb.CreateClientRatingResponse, error) {
	...
	return &pb.CreateClientRatingResponse{}, nil
}
